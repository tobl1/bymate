...
import { ROLE_SUGGESTIONS, STAGE_LABELS, type Listing, type Stage } from '@/lib/types'
...
export default function EditListingPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      setStealth(l.stealth)
      setStartupName(l.startup_name ?? '')
      setIndustry(l.industry)
      setStage(l.stage)
      setLocation(l.location)
      setDescription(l.description)
      setRoles(l.roles_needed)
      setReady(true)
    })()
  }, [id])
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="max-w-2xl mx-auto px-6 pt-4 pb-24">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Field label="Stage *">
            <select value={stage} onChange={e => setStage(e.target.value as Stage)} className="field">
